    ...
    <div class="container" style="width: 90%; margin: auto;">
        ...
        <form action='' method='POST' class="form-horizontal">
            <div class="control-group">
                ...
                <div class="controls">
                    <input class="input-xlarge" type="number" placeholder="CCF****" name='product_id' value='<?php echo stripslashes($row['product_id']) ?>' />
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input class="input-xlarge" type="text" placeholder="Area-X.." name='manufacture' value='<?php echo stripslashes($row['manufacture']) ?>' />
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="f_ac"> Products's rate</label>
                <div class="controls">
                    <input class="input-xlarge" type="number" placeholder="Bank account number ******.." name='rate' value='<?php echo stripslashes($row['rate']) ?>' />
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="f_phone"> Weight</label>
                <div class="controls">
                    <input class="input-xlarge" type="number" placeholder="+254******.." name='weight' value='<?php echo stripslashes($row['weight']) ?>' />
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="number"> Cost</label>
                <div class="controls">
                    <input class="input-xlarge" type="number" placeholder="+254******.." name='cost' value='<?php echo stripslashes($row['cost']) ?>' />
                </div>
            </div>
            <div class="control-group">
                <div class="controls">
